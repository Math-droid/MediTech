                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a href="{{ url('/dashboard') }}"
                            class="nav-link py-3 px-0 px-lg-3 rounde">Dashboard</a></li>
                        @else
                        <li class="nav-item mx-0 mx-lg-1"><a href="{{ route('login') }}"
                            class="nav-link py-3 px-0 px-lg-3 rounde">Log
                            in</a></li>

                        @if (Route::has('register'))
                        <li class="nav-item mx-0 mx-lg-1"><a href="{{ route('register') }}"
                            class="ml-4 nav-link py-3 px-0 px-lg-3 rounde">Register</a></li>
                        @endif
                        @endauth
                    </div>
                    @endif
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-xl-7">
                    ...
                    <form action="#" method="post" id="contactForm" data-sb-form-api-token="API_TOKEN">
                        ...
                        <!-- Phone number input-->
                        <div class="form-floating mb-3">
                            <input class="form-control" id="phone" type="tel" placeholder="(11) 94444-4444"
                                data-sb-validations="required" />
                            <label for="phone">Número celular</label>
                            <div class="invalid-feedback" data-sb-feedback="phone:required">um número é necessário</div>
                        </div>
                        <!-- Message input-->
                        <div class="form-floating mb-3">
                        ...
                        <!-- Submit Button-->
                        <button class="btn btn-primary btn-xl enable" id="submitButton" type="submit">Send</button>
                    </form>
                </div>
            </div>
        </div>
